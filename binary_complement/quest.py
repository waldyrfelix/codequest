...
The binary complement is formed by flipping all bits of its binary representation 
(changing 0 to 1 and vice versa). Return the decimal value of the binary complement.
